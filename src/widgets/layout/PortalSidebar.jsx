import { PortalSidebarRoutes } from '@/routes/PortalSidebarRoutes';
...
const PortalSidebar = () => {
  ...
  return (
   <>
      ...
      >
        {/* Logo Section */}
        {/* <div className="w-28 mx-auto py-4 lg:py-2 mt-16 lg:mt-0" onClick={() => navigate('/')}>
        ...
        <nav className="flex-1 px-4 py-6 overflow-y-auto">
          <div className="space-y-2">
            {PortalSidebarRoutes.map(({ path, label, icon: Icon }) => (
              <Link
                key={path}
                to={`/${path}`}
