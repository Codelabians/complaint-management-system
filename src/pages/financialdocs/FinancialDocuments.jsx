...
const FinancialDocuments = () => {
  ...
  const documents = Array.from({ length: 12 }, (_, i) => ({
    id: i + 1,
    name: 'May 2024 Financials',
    month: '06',
    date: '2025',
    file: 'Financial-docs-2024-05.pdf'
  }));
  ...
  return (
   <div className="min-h-screen bg-gray-50 p-6">
      <div className="w-full bmd:w-[90%] mx-auto">
        {/* Header */}
       <Heading heading="Financial Docs"/>
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center justify-end space-x-2">
                        ...
                        <button
                          ...
                          className="p-2  hover:text-orang rounded-lg transition-all"
                          title="View"
                        >
                        ...
                        <button
                          ...
                          className="p-2  hover:text-orangerounded-lg transition-all"
                          title="Delete"
                        >
          ...
          <div className="flex items-center justify-between mt-6">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="px-3 py-2 text-sm font-medium text-orange bg-white border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
              >
                Previous
              </button>
